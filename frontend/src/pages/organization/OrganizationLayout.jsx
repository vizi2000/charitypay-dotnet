...
export function OrganizationLayout() {
  ...
  const navigation = [
    {
      name: t('organization.dashboard'),
      href: '/organization/dashboard',
      icon: HomeIcon,
      description: t('organization.dashboardDesc')
    },
    {
      name: t('organization.profile'),
      href: '/organization/profile',
      icon: UserIcon,
      description: t('organization.profileDesc')
    },
    {
      name: t('organization.payments'),
      href: '/organization/payments',
      icon: CreditCardIcon,
      description: t('organization.paymentsDesc')
    },
    {
      name: t('organization.qr'),
      href: '/organization/qr',
      icon: QrCodeIcon,
      description: t('organization.qrDesc')
    },
    {
      name: t('organization.settings'),
      href: '/organization/settings',
      icon: Cog6ToothIcon,
      description: t('organization.settingsDesc')
    }
  ];
  ...
  const isActivePath = (path) => {
    if (path === '/organization/dashboard') {
      return location.pathname === '/organization/dashboard';
    }
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-slate-900 truncate">
                  {user?.full_name || 'Organization User'}
                </p>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4 lg:ml-0">
                <h1 className="text-lg font-semibold text-slate-900">
                  {navigation.find(item => isActivePath(item.href))?.name || t('organization.panel')}
                </h1>
              </div>
            </div>
